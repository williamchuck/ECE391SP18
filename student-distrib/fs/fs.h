...
extern void init_fs();
extern int32_t f_open(const int8_t* fname);
extern int32_t f_read(int32_t fd, void* buf, int32_t size);
extern int32_t f_write(int32_t fd, const void* buf, int32_t size);
